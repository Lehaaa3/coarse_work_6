    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='distribution.client', verbose_name='клиент рассылки')),
                ('mailing_list', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='distribution.mailingsettings', verbose_name='рассылка')),
            ],
            options={
                'verbose_name': 'лог',
