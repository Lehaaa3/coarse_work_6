    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('periodicity', models.DurationField(choices=[(datetime.timedelta(days=1), 'Раз в день'), (datetime.timedelta(days=7), 'Раз в неделю'), (datetime.timedelta(days=30, seconds=43200), 'Раз в месяц')], default=datetime.timedelta(days=1), verbose_name='периодичность')),
        ...
        migrations.CreateModel(
            name='MailingSettingsCreateView',
            fields=[
                ('client_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='distribution.client')),
            ],
            bases=(distribution.views.GetContextDataMixin, 'distribution.client', django.views.generic.edit.CreateView),
        ),
        migrations.CreateModel(
            name='Message',
            fields=[
